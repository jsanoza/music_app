class SpotAlbumReleases {
  Albums? albums;

  SpotAlbumReleases({this.albums});

  SpotAlbumReleases.fromJson(Map<String, dynamic> json) {
    albums = json['albums'] != null ? new Albums.fromJson(json['albums']) : null;
  }
...
class Albums {
  ...
  Albums({this.href, this.items, this.limit, this.next, this.offset, this.previous, this.total});
...
class Items {
  ...
  Items({this.albumGroup, this.albumType, this.artists, this.availableMarkets, this.externalUrls, this.href, this.id, this.images, this.name, this.releaseDate, this.releaseDatePrecision, this.totalTracks, this.type, this.uri});
